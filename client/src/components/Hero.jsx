            ...
            <div className="max-w-7xl mx-auto px-6 w-full relative h-full flex flex-col justify-center">
                ...
                >
                    <div className="flex gap-8 text-secondary">
                        <a href="https://github.com/Amangarg5990" target="_blank" rel="noreferrer" className="hover:text-emerald-400 transition-all transform hover:-translate-y-2 hover:scale-110 duration-300">
                            <i className="fab fa-github text-3xl"></i>
                        </a>
                        <a href="https://www.linkedin.com/in/amangarg09/" target="_blank" rel="noreferrer" className="hover:text-blue-500 transition-all transform hover:-translate-y-2 hover:scale-110 duration-300">
                            <i className="fab fa-linkedin-in text-3xl"></i>
                        </a>
                        <a 
                            href="mailto:amangarg5990@gmail.com" 
