        ...
        >
            <div className="max-w-[95%] mx-auto px-6 flex justify-between items-center">
                <a href="#" className="flex items-center gap-1 text-2xl font-black text-primary tracking-tighter">
                    A<span className="text-emerald-400">/</span><span className="text-cyan-400">&gt;</span>
                </a>
                ...
                <div className="flex items-center gap-4 md:gap-6 lg:gap-8 xl:gap-10">
                    ...
                    <button
                        className="lg:hidden text-gray-300 text-2xl ml-2 hover:text-emerald-400 transition-colors"
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="lg:hidden mobile-nav-bg border-t border-[var(--card-border)] absolute w-full left-0 top-full overflow-hidden shadow-2xl"
                    >
                        <div className="px-6 py-8 space-y-4">
                            {['About', 'Experience', 'Training', 'Skills', 'Coding', 'Projects', 'Contact'].map((item, idx) => (
                                <motion.a
                                    key={item}
