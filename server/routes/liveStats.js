...
const LEETCODE_USERNAME = 'Amangarg09';
const HACKERRANK_USERNAME = 'amangarg5990';
const GFG_USERNAME = 'amangarg5990';
...
router.get('/all', async (req, res) => {
    ...
    if (!results.gfg) {
        try {
            ...
            results.gfg = { solved: pd.coding?.gfg?.solved || 102 };
            results.totalSolved += results.gfg.solved;
        } catch { }
    }
