    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://api.web3forms.com/submit', {
                ...
                body: JSON.stringify({
                    access_key: '2956bf00-6a1e-47fe-bc8f-447912340970',
                    ...formData
                }),
            });
            ...
            try {
                ...
                console.warn('Could not save message locally:', localErr);
            }
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-5 flex flex-col gap-8">
                        ...
                        <div className="p-8 bg-gradient-to-br from-[var(--bg-secondary)] to-[var(--bg-primary)] backdrop-blur-xl border border-[var(--card-border)] rounded-3xl shadow-xl hover:border-emerald-500/40 hover:shadow-[0_0_30px_rgba(52,211,153,0.1)] transition-all duration-500 relative overflow-hidden group">
                            ...
                            <div className="flex flex-col gap-4 relative z-10">
                                ...
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    href="/assets/CV.png"
                                    download="Aman_Garg_CV_Specialized.png"
                                ...
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    href="/assets/CV2.png"
                                    download="Aman_Garg_CV_General.png"
                        ...
                        <div className="p-8 bg-[var(--bg-secondary)] backdrop-blur-xl border border-[var(--card-border)] rounded-3xl shadow-xl hover:border-emerald-500/30 transition-all duration-500">
                            ...
                            <div className="flex flex-wrap gap-4">
                                {[
                                    { icon: 'github', color: 'text-white', link: 'https://github.com/Amangarg5990', bgHover: 'hover:border-white/50' },
                                    { icon: 'linkedin-in', color: 'text-[#0A66C2]', link: 'https://www.linkedin.com/in/amangarg09/', bgHover: 'hover:border-[#0A66C2]/50' },
                                    { icon: 'envelope', color: 'text-emerald-400', link: 'mailto:amangarg5990@gmail.com', bgHover: 'hover:border-emerald-400/50', type: 'fas' }
                                ].map((social, idx) => (
                                    <motion.a
                                        key={idx}
                                        href={social.link}
