...
const Skills = ({ softSkills }) => {
    ...
    const technicalSkills = [
        ...
        { name: "Power BI", icon: "fa-solid fa-chart-pie", color: "#F2C811" },
        { name: "MS-Excel", icon: "fa-solid fa-file-excel", color: "#217346" },
    ...
    // Balanced layout for 22 skills
    const rowConfig = [7, 6, 5, 4];
    let skillIndex = 0;
